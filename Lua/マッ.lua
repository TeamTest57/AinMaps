...
export.syns = {
	...
	-- Hokkaido: Northern
	["Asahikawa"]	= { "マッ:mát((HC))", "クコㇿメノコ:kukórmenoko (私の)", "クコㇿカッケマッ:kukórkatkemat (私の)((H))" },
	...
	["Kuril"]	= { "" },
	["Paramushir"]	= { "" },
	["Shumshu"]	= { "カニコㇰカイ:kani kokkai (136)", "マチ:machi (162)((H))", "ㇰマイ:k=mac=i(妻)((V))" },

	-- Kuril: Southern
	["Etorofu"]	= { "" },
	["South Kuril"]	= { "クマイ:ku-mac-i(妻)((BS))" },
}
