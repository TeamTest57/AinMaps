...
export.syns = {
	...
	["Soya"]	= { "アキアチ:akí'aci [日本語?]((H))" },
	["Teshio"]	= { "ホマ:homa((C2))" },

	-- Hokkaido: Eastern
	["Abashiri"]	= { "チュポロ:cuporo((C2))" },
	["Akan"]	= { "" },
	["Ashoro"]	= { "オキライ:okiray((C2))" },
	["Bihoro"]	= { "カムイチェㇷ゚:kamuycep", "シペ:sipe (秋の)", "チュキペ:cukipe (秋の)((H))", "オキライ:okiray", "オㇱ:os", "チェㇷ゚ポ:ceppo", "ホㇱ:hos", "イチャノルンチェㇷ゚:icanoruncep", "イシルチャ:isiruca", "イシルチェㇷ゚:isirucep", "イシルオㇱ:isiruos", "イットオマサㇰ:ittoomasak", "メㇰカウㇱ:mekkaus", "ノチコイケチェㇷ゚:nocikoykecep", "ペッノンカㇻ:pet nonkar", "ペトゥㇱチェㇷ゚:petuscep", "シペラㇺ:siperam", "ウペンチェㇷ゚:upencep", "ヤイトゥイカコㇿ:yay tuy ka kor((C2))" },
	["Biroo"]	= { "" },
	["Chirotto"]	= { "" },
	...
	-- Sakhalin: West Coast
	["Chirai"]	= { "" },
	["Maoka"]	= { "チュㇷチェㇸ:cuhceh", "オキライ:okiray", "チェペサㇵケ:cepesahke", "テタラチェㇸ:tetaraceh((C2))" },
	...
	["Aihama"]	= { "" },
	["Nairo"]	= { "" },
	["Niitoi"]	= { "チュㇷチェㇸ:cuhceh", "チェㇸサㇵケ:cehsahke((C2))" },
	...
	["Kuril"]	= { "" },
	["Paramushir"]	= { "" },
	["Shumshu"]	= { "シヘㇷ゚:shichep(151)", "サケ:sake(169)((H))" },
